...
<div id="hbminis">
	...
	<!-- <h1><?php echo JText::_('COM_HBMANAGER_MINIS_TITLE'); ?></h1> -->
		...
		<?php if ($this->show['team']) : ?>
			...
			<?php if ($this->show['training']) : ?>
				...
				<div class="hbtraining">
					...
					<?php if (!empty($this->coaches[$key])) : ?>
						<dt><?php echo JText::_('COM_HBMANAGER_TEAM_TRAINING_COACH') ?></dt>
						
						<?php foreach ($this->coaches[$key] as $coach) : ?>
						<dd>
					...
					<?php if (!empty($this->trainings[$key])) : ?> 
						<dt><?php echo JText::_('COM_HBMANAGER_TEAM_TRAINING_TIMES') ?></dt>
						<?php foreach ($this->trainings[$key] as $training) : ?>
						<dd> 
							<span>
