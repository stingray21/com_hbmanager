...
<div id="j-main-container" class="span10">
	...
	<div id="gamesall">
		...
		<p><?php echo (!empty($team->leagueIdHvw)) ? '<a href="' . $link . '" target="_BLANK">' . $link . '</a>' : JText::_('COM_HBMANAGER_GAMESALL_NO_DATA'); ?>
		</p>
		...
		<table class="schedule">
			...
			<tbody>
				...
				<tr class="">
					...
					<td>-</td>
					<td class="leftalign <?php echo ($game->ownTeam === 2) ? ' heim' : '' ?>"><?php echo $game->away ?>
					</td>
				</tr>
