  ...
  return function (t) {
    ...
    function n(t, e, i) {
      if (i) {
        ...
        for (s in i) if (n = i[s], h.isArray(n)) for (o = 0, a = n.length; a > o; o++) r(t, e, s, n[o]);else r(t, e, s, n);
      }
    }
    ...
    e._compile = function (t) {
      ...
      if (!this._isBeingDestroyed) {
        ...
        for (n && !n._isBeingDestroyed && (i = n._children.indexOf(this), n._children.splice(i, 1)), i = this._children.length; i--;) this._children[i].$destroy();
    ...
    function u(t, e, i) {
      for (var n, r, s, o = [], a = e.length; a--;) if (n = e[a], /[A-Z]/.test(n), r = t.getAttribute(n), null !== r) {
        s = {
          name: n,
          value: r
        };
    ...
    e.parse = function (t) {
      ...
      for (s = t, h = l = !1, u = f = d = p = v = 0, b = 0, m = [], _ = {}, g = null, a = 0, c = s.length; c > a; a++) if (o = s.charCodeAt(a), h) 39 === o && (h = !h);else if (l) 34 === o && (l = !l);else if (44 !== o || d || u || f) {
    ...
    n.addSub = function (t) {
      ...
      for (var t = 0, e = this.subs; t < e.length; t++) e[t].update();
    }, t.exports = e;
  }, function (t, e, i) {
    ...
    function i(t) {
      ...
      return new t(function () {
        for (var t = e.length, i = 0; t > i; i++) e[i]();
