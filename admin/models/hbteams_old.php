...
{	
	...
	{
		$leagueArray = self::getLeagueArrayFromHVW();
	...
	function getLeagueArrayFromHVW($address)
	{
		...
		$source = self::getSource($address);
		$leagueArray = self::formatSource($source);
		
		
		
		//echo __FILE__.'<pre>';print_r($leagueArray); echo'</pre>';
		return $leagueArray;	
	}
	...
	protected function formatSource($source)
	{
		foreach ($source as $key => $value) {
			echo __FILE__.'<pre>';print_r($value); echo'</pre>';
